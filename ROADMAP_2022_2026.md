...
CeloHT's GitHub presence historically used the legacy Celo-HT organization for public repositories, issue trackers, and discussion forums, consistent with the Open Source Collaboration principle in `GOVERNANCE.md` Section 2.4. Current links use `Celo-HaiTi`.
