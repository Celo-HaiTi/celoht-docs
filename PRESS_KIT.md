...
All logo files are available in the repository root as SVG and PNG assets, with SVG preferred for print and digital use. See [LOGO_GUIDELINES.md](./LOGO_GUIDELINES.md) before publishing.
