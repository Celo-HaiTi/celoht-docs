...
**Version:** 1.0.0
**Effective Date:** 2026
**Maintained By:** CeloHT community contributors under the documented collective governance process
...
- Establish RFC 2119-grade obligations so that partnership decisions are consistent and reviewable over time, independent of who participates.

This policy applies to all CeloHT repositories, all official CeloHT communication channels (celoht.com, @CeloHT / celohtofficial on Facebook and Instagram, contact@celoht.com), and all individuals acting in an official capacity on behalf of CeloHT, including the Founder, Maintainers, and designated Community Contributors.
...
An organization is eligible for consideration under any category above the level of "Supporter" only if it satisfies **all** of the following minimum criteria. The applicable documented collective process MAY apply additional criteria proportionate to risk.
...
| **Tier 3 — Enhanced** | Confirmed Partners, any relationship involving funds transfer, data sharing, or co-branding | Tier 2 + financial review, reference checks, written risk assessment, documented collective approval |
...
| Mission-alignment review | Written summary against Guiding Principles | Designated reviewer |
...
| Conflict-of-interest screen | Cross-check against CeloHT COI disclosures | Designated reviewers |
| Risk assessment | Completed Risk Assessment (Section 9 / Appendix A template) | Designated reviewers |
...
flowchart TD
    ...
    H --> I
    I --> J[Submit to Documented Collective Process]
...
CeloHT reserves the right to decline or exit any relationship that the documented collective process determines is inconsistent with these ethical commitments, even where no law has been broken.
...
4. Any participant who becomes aware of suspected corruption involving a CeloHT partnership MUST report it under the process described in [Section 14](#14-conflict-of-interest-policy).
...
2. Reasonable, proportionate, and transparently disclosed hospitality (e.g., a modest working meal during an in-person meeting) is permitted and SHOULD be logged if it exceeds a nominal value threshold To Be Established through the documented collective process.
...
3. Any suspected fraudulent activity connected to a partnership MUST be documented and escalated through the documented collective process as soon as safely possible.
...
1. A conflict of interest exists whenever any person involved in a partnership decision has a financial, familial, or other personal interest in the outcome.
...
3. An individual with a disclosed conflict MUST recuse themselves from the decision and SHOULD recuse themselves from substantive deliberation unless the documented collective process determines their input is necessary and records that decision.
4. All conflict-of-interest disclosures MUST be retained in the governance record for a minimum of five (5) years.
5. Failure to disclose a known conflict of interest is a governance violation and MAY result in removal from any role under [GOVERNANCE.md](./GOVERNANCE.md).
...
3. Reforestation-related partnerships MUST respect the current **pilot-phase** status of this pillar; no partner communication MAY describe reforestation operations as fully scaled or operational until a documented collective decision updates this status.
...
flowchart TD
    ...
    D --> E[5. Documented Collective Approval]
...
flowchart TD
    ...
    CG --> PL[Partnerships Lead or designated reviewers]
    PL --> DD[Due Diligence Reviewers]
    PL --> REG[Public Partnership Registry Maintainer]
```

- Founder status does not create partnership approval authority; no individual may unilaterally approve partnerships. See [Section 22](#22-approval-process).
- Partnership approval, suspension, and termination require the applicable documented collective process. The approval threshold is To Be Established before each process begins.
...
|---|---|---|
| **Founder** | Historical and institutional context when requested | No automatic approval authority |
| **Designated reviewers** | Review due diligence and risk assessments; maintain this policy and registry records | Recommends, does not unilaterally approve |
...
|---|---|
| Supporter | Logged review under the applicable process |
| Ecosystem Participant | Documented collective approval |
| Strategic Collaborator | Documented collective approval |
| Confirmed Partner | Documented collective approval and authorized signatures |
...
These are target service levels, not binding deadlines; the documented collective process MAY extend timelines where diligence is incomplete.
...
3. No partnership funds MAY be commingled with undisclosed personal accounts of any Founder, Maintainer, or Community Contributor.
...
3. Anonymous donations above a threshold To Be Established through the documented collective process MUST undergo enhanced source-of-funds review before acceptance.
...
2. In-kind contributions above a materiality threshold To Be Established through the documented collective process SHOULD undergo the same due-diligence tier as an equivalent cash contribution.
...
4. Anyone reviewing confidential information remains bound by the [Conflict of Interest Policy](#14-conflict-of-interest-policy) and MUST NOT use confidential partner information for personal benefit.

---

## 31. Monitoring and Evaluation

1. Every Strategic Collaborator and Confirmed Partner relationship MUST have a designated monitor responsible for tracking progress against agreed objectives.
...
3. Material deviations from agreed scope, budget, or timeline MUST be logged and, where significant, escalated through the documented collective process.
...
flowchart TD
    ...
    B --> C[Documented Collective Review]
...
A composite score below a threshold To Be Established through the documented collective process MUST trigger a formal discussion of suspension or termination.
...
1. Any participant MAY propose suspension of a partnership where there is credible concern of a compliance, ethics, financial, or reputational issue.
2. Suspension requires the documented collective process and takes effect only when that outcome is recorded, pending investigation.
...
2. Termination by CeloHT requires the documented collective process. Minimum necessary containment may occur immediately in cases of confirmed fraud, corruption, or legal violation, but the action and subsequent collective outcome must be recorded.
...
1. This policy MAY be amended through the documented collective governance process. The applicable threshold is To Be Established before the process begins.
...
## 11. Signatures
Authorized CeloHT representative: ______________  Date: ______
...
- [`GOVERNANCE.md`](./GOVERNANCE.md) — Collective governance and Community Contributor structure
